    ...
    >
      Змінити фото
        ...
        <div className="photo-tips">
          ...
          <ul>
            <li>На зображенні має бути одна людина або тварина</li>
            <li>Якісне фото з обличчям ближче до центру композиції</li>
            <li>Чітка композиція без обрізаних важливих елементів</li>
          </ul>
        </div>
      </div>
    </section>
